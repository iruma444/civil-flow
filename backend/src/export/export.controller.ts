...
export class ExportController {
    ...
    async exportMyAttendanceCSV(
        ...
        res.setHeader('Content-Disposition', `attachment; filename=attendance_${yearNum}_${monthNum}.csv`);
    ...
    async exportAllAttendanceCSV(
        ...
        res.setHeader('Content-Type', 'text/csv; charset=utf-8');
        res.setHeader('Content-Disposition', `attachment; filename=all_attendance_${yearNum}_${monthNum}.csv`);
        res.send('\uFEFF' + csv);
    }
